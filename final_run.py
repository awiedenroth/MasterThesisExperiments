...
def main():
    ...
    with open("./TestDataset/oesch16_ohne/meta_model.pkl", "wb") as f:
        pickle.dump(meta_model, f)
    with open("./TestDataset/oesch16_ohne/ft_model.pkl", "wb") as f:
        pickle.dump(fasttext_model, f)
    with open("./TestDataset/oesch16_ohne/combi_model.pkl", "wb") as f:
        pickle.dump(combi_model, f)

    with open("./TestDataset/oesch16_ohne/meta_Xtrain.pkl", "wb") as f:
        pickle.dump(X_train_meta, f)
    with open("./TestDataset/oesch16_ohne/ft_Xtrain.pkl", "wb") as f:
        pickle.dump(X_train_fasttext, f)
    with open("./TestDataset/oesch16_ohne/combi_Xtrain.pkl", "wb") as f:
        pickle.dump(X_train_combi, f)

    with open("./TestDataset/oesch16_ohne/meta_ytrain.pkl", "wb") as f:
        pickle.dump(y_train_meta, f)
    with open("./TestDataset/oesch16_ohne/ft_ytrain.pkl", "wb") as f:
        pickle.dump(y_train_fasttext, f)
    with open("./TestDataset/oesch16_ohne/combi_ytrain.pkl", "wb") as f:
        pickle.dump(y_train_combi, f)

    with open("./TestDataset/oesch16_ohne/meta_Xtest.pkl", "wb") as f:
        pickle.dump(X_test_meta, f)
    with open("./TestDataset/oesch16_ohne/ft_Xtest.pkl", "wb") as f:
        pickle.dump(X_test_fasttext, f)
    with open("./TestDataset/oesch16_ohne/combi_Xtest.pkl", "wb") as f:
        pickle.dump(X_test_combi, f)

    with open("./TestDataset/oesch16_ohne/meta_ytest.pkl", "wb") as f:
        pickle.dump(y_test_meta, f)
    with open("./TestDataset/oesch16_ohne/ft_ytest.pkl", "wb") as f:
        pickle.dump(y_test_fasttext, f)
    with open("./TestDataset/oesch16_ohne/combi_ytest.pkl", "wb") as f:
        pickle.dump(y_test_combi, f)

    json.dump(evaluation_meta, open("./TestDataset/oesch16_ohne/meta_result.json", 'w'))
    json.dump(evaluation_fasttext, open("./TestDataset/oesch16_ohne/ft_result.json", 'w'))
    json.dump(evaluation_combi, open("./TestDataset/oesch16_ohne/combi_result.json", 'w'))
    json.dump(evaluation_combi_confidence, open("./TestDataset/oesch16_ohne/combi_conf_result.json", 'w'))

    json.dump(evaluation_meta_train, open("./TestDataset/oesch16_ohne/meta_report_train.json", 'w'))
    json.dump(evaluation_fasttext_train, open("./TestDataset/oesch16_ohne/ft_report_train.json", 'w'))
    json.dump(evaluation_combi_train, open("./TestDataset/oesch16_ohne/combi_report_train.json", 'w'))

    json.dump(evaluation_meta_val, open("./TestDataset/oesch16_ohne/meta_report_test.json", 'w'))
    json.dump(evaluation_fasttext_val, open("./TestDataset/oesch16_ohne/ft_report_test.json", 'w'))
    json.dump(evaluation_combi_val, open("./TestDataset/oesch16_ohne/combi_report_test.json", 'w'))
