...
def main(configuration):
    run = wandb.init(project="Masterarbeit_ft", entity="awiedenroth", config=configuration,
                     name=f"{configuration['oesch']} {configuration['selbstständige']} {configuration['ft_model']} {configuration['name']}")
...
if __name__ == '__main__':
    ...
    experiments = [
        ...
        {
            "name": "wörterbuch & lowercase",
            "fasttext_zusatzdaten": True,
            "lowercase": True
        },
        {
            "name": "keyboard & wörterbuch",
            "keyboard_aug": True,
            "fasttext_zusatzdaten": True
        },
        {
            "name": "keyboard & wörterbuch & lowercase",
            "keyboard_aug": True,
            "fasttext_zusatzdaten": True,
            "lowercase": True
        }
